...
FROM (VALUES
    ...
    ('Screen Cleaning', 'Remove and clean window screens', 'addon', 0.04, 50.00, 25.00, true, 3),
    ('Track Cleaning', 'Clean window tracks and sills', 'addon', 0.04, 40.00, 20.00, true, 4),
    ('Skylights & Hard-to-Reach Glass', 'Custom pricing for difficult access windows', 'upsell', 0.20, 100.00, 75.00, true, 5),
    ('Pressure Washing', 'Exterior surface cleaning', 'upsell', 0.15, 200.00, 150.00, true, 6),
    ('Gutter Cleaning', 'Clean and inspect gutters', 'upsell', 0.00, 150.00, 100.00, true, 7)
...
-- Set default email templates if they don't exist (update all rows since we don't know the specific UUID)
UPDATE settings 
SET 
