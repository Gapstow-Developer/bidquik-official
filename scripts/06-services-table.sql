...
SELECT * FROM (VALUES
    ('Interior & Exterior Window Cleaning', 'Complete window cleaning service for both inside and outside', 'main', 0.13, NULL, 250.00, true, 1),
    ('Exterior Only Window Cleaning', 'Professional exterior window cleaning service', 'main', 0.08, NULL, 150.00, true, 2),
